	...
	function render(){
		...
		//if(isset($this->value) && is_array($this->value)){
			...
			//&& ($this->value['post-type-name'][$i]!='')
                       ...
                       echo '<li class="vibe-label vibe-new"><h2>Custom Post Type : '.$this->value['post-type-name'][$i].' &rsaquo;</h2><a href="javascript:void(0);" class="vibe-opts-custom-post-remove">'.__('Remove', 'micronet').'</a>
		...
		echo '<li id="new_custom_post" class="vibe-label" style="display:none;"><h2>New Custom Post Type </h2><a href="javascript:void(0);" class="vibe-opts-custom-post-remove">'.__('Remove', 'micronet').'</a>
		...
		echo '<a href="javascript:void(0);" class="vibe-btn green vibe-opts-custom-post-add " rel-id="'.$this->field['id'].'-ul" rel-name="'.$this->args['opt_name'].'['.$this->field['id'].'][]">'.__('Add More', 'micronet').'</a><br/>';
