...
class Vibe_Options_upload extends Vibe_Options{	
	...
	*/
	function render(){
		...
		echo ' <a href="javascript:void(0);" class="vibe-opts-upload button-secondary"'.$upload.' rel-id="'.$this->field['id'].'"  data-title="'.$this->field['title'].'"  data-save="#'.$this->field['id'].'" data-target="#vibe-opts-screenshot-'.$this->field['id'].'">'.__('Browse', 'micronet').'</a>';
