	...
	function register_required_plugins() {
	    ...
	    $plugins = array(
	        ...
	        array(
	            'name'                  => 'VibeBP',
	            'slug'                  => 'vibebp',
	            'source'                => VIBE_URL.'/plugins/vibebp.zip',
	            'required'              => true, 
	            'version'               => '', 
	            'force_activation'      => false,
	            'force_deactivation'    => false,
        	...
        	array(
	            'name'                  => 'Vibe Appointments',
	            'slug'                  => 'vibe-appointments',
	            'source'                => VIBE_URL.'/plugins/vibe-appointments.zip',
	            'required'              => true, 
	            'version'               => '', 
	            'force_activation'      => false,
	            'force_deactivation'    => false,
        	...
        	array(
	            'name'                  => 'Vibe Zoom',
	            'slug'                  => 'vibe-zoom',
	            'source'                => VIBE_URL.'/plugins/vibe-zoom.zip',
	            'required'              => false, 
	            'version'               => '', 
	            'force_activation'      => false,
	            'force_deactivation'    => false,
        	...
        	array(
	            'name'                  => 'Vibe Earnings',
	            'slug'                  => 'vibe-earnings',
	            'source'                => VIBE_URL.'/plugins/vibe-earnings.zip',
	            'required'              => false, 
	            'version'               => '', 
	            'force_activation'      => false,
	            'force_deactivation'    => false,
