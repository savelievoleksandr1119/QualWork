...
jQuery(document).ready(function($){
	...
	$('.import_complete_demo').on('click',function(){
		var $this =  $(this);
		demo = $this.data('demo');
		...
		$.ajax({
            type: "POST",
            url: ajaxurl,
            data: { action: 'import_complete_demo', 
    ...
    $('.import_ele_template').on('click',function(){
        var $this =  $(this);
        demo = $this.data('demo');
        ...
        $.ajax({
            type: "POST",
            url: ajaxurl,
            data: { action: 'import_wplms_demos_elementor_template', 
                    security: $('#switch_demo_layouts').val(),
                    demo:demo
                  },
            cache: false,
