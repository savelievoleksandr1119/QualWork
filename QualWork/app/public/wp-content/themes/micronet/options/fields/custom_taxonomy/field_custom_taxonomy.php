	...
	*/
	function render(){
		...
		echo '<li style="display:none;clear:both;">
                    ...
                    <a href="javascript:void(0);" class="vibe-opts-custom-taxonomy-remove">'.__('Remove', 'micronet').'</a>
                     </li>';
		
		echo '</ul>';
		
		echo '<a href="javascript:void(0);" class="vibe-btn green vibe-opts-custom-taxonomy-add " rel-id="'.$this->field['id'].'-ul" style="text-align:center;">'.__('Add New Listing Taxonomy', 'micronet').'</a><br/>';
