	...
	function render(){
		...
		if(isset($this->value) && is_array($this->value)){
			foreach($this->value as $k => $value){
				if($value != ''){
                                                echo '<li>
                                                        <h2>Custom Font : '.esc_attr($value).' &rsaquo;</h2><a href="javascript:void(0);" class="vibe-opts-custom-font-remove">'.__('Remove', 'micronet').'</a>';
                                                echo '</li>';
                                    }
                                }
                        }       
                                      ...
                                      echo '</li>';
                 echo '</ul>';
                 echo '<a class="button button-primary font-upload">'.__('Upload Font', 'micronet').'</a><br/>';                      
